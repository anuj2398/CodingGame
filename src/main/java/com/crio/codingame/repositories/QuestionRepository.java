...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
       ...
       for(Map.Entry<String,Question> mp : questionMap.entrySet()){
            listOfQuestions.add(mp.getValue());
       }
       if(listOfQuestions.isEmpty()) return Collections.emptyList();
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
     ...
     for(Map.Entry<String,Question> mp : questionMap.entrySet()){
        if(mp.getValue().getLevel().equals(level)){
